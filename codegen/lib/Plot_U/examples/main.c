...
#include "Plot_U.h"
#include "main.h"
#include "Plot_U_terminate.h"
#include "Plot_U_initialize.h"
...
static void main_Plot_U(void)
{
  ...
  /* Initialize function 'Plot_U' input arguments. */
  /* Initialize function input argument 'transdutor'. */
  /* Call the entry-point 'Plot_U'. */
