/*
 * File: _coder_Calc_pressao_api.c
 *
...
#include "_coder_Calc_pressao_mex.h"
  ...
  *msgId, real_T ret[64])
{
  ...
  emlrtCheckBuiltInR2012b(emlrtRootTLSGlobal, msgId, src, "double", false, 1U,
    dims);
  for (i0 = 0; i0 < 64; i0++) {
    ret[i0] = (*(real_T (*)[64])mxGetData(src))[i0];
  }
 ...
 * Return Type  : void
 */
void Calc_pressao_api(const mxArray * const prhs[4], const mxArray *plhs[1])
{
  real_T x;
  real_T y;
  real_T z;
 ...
 * Return Type  : void
 */
void Calc_pressao_atexit(void)
{
  mexFunctionCreateRootTLS();
  emlrtEnterRtStackR2012b(emlrtRootTLSGlobal);
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
  Calc_pressao_xil_terminate();
}
 ...
 * Return Type  : void
 */
void Calc_pressao_initialize(void)
{
  mexFunctionCreateRootTLS();
 ...
 * Return Type  : void
 */
void Calc_pressao_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}
...
/*
 * File trailer for _coder_Calc_pressao_api.c
 *
 * [EOF]
 */
