...
#include "main.h"
#include "Calc_pressao_terminate.h"
#include "Calc_pressao_initialize.h"
...
static void main_Calc_pressao(void);
...
static void main_Calc_pressao(void)
{
  ...
  /* Initialize function 'Calc_pressao' input arguments. */
  /* Initialize function input argument 'transdutor'. */
  /* Call the entry-point 'Calc_pressao'. */
  argInit_struct0_T(&r0);
  p_total = Calc_pressao(argInit_real_T(), argInit_real_T(), argInit_real_T(),
    &r0);
}
