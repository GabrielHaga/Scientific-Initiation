...
MAKEFILE = Calc_pressao_mex.mk

include Calc_pressao_mex.mki


SRC_FILES =  \
	Calc_pressao_data.c \
	Calc_pressao_initialize.c \
	Calc_pressao_terminate.c \
	Calc_pressao.c \
	calc_r.c \
	...
	calc_p.c \
	sum.c \
	_coder_Calc_pressao_info.c \
	_coder_Calc_pressao_api.c \
	_coder_Calc_pressao_mex.c \
	c_mexapi_version.c

MEX_FILE_NAME_WO_EXT = Calc_pressao_2_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\Calc_pressao"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\Calc_pressao/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
