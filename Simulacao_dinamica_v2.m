...
%     Fd = [0;0;0];
    Fgx = -(Calc_Gorkov_mex(x+disc/2, y, z, transdutor) - Calc_Gorkov_mex(x-disc/2, y, z, transdutor))/disc;
    Fgy = -(Calc_Gorkov_mex(x, y+disc/2, z, transdutor) - Calc_Gorkov_mex(x, y-disc/2, z, transdutor))/disc;
    Fgz = -(Calc_Gorkov_mex(x, y, z+disc/2, transdutor) - Calc_Gorkov_mex(x, y, z-disc/2, transdutor))/disc;
