...
while i <= n
    ...
    v = [vx; vy; vz];
%     Fd = [0;0;0];
    Fgxg = -(Calc_Gorkov_estacionario(x+disc/2, y, z, transdutor)-...
        Calc_Gorkov_estacionario(x-disc/2, y, z, transdutor))/disc;
    Fgyg = -(Calc_Gorkov_estacionario(x, y+disc/2, z, transdutor)-...
        Calc_Gorkov_estacionario(x, y-disc/2, z, transdutor))/disc;
    Fgzg = -(Calc_Gorkov_estacionario(x, y, z+disc/2, transdutor)-...
...
saveas(1,'D:\Usuarios\IC\Relatório final FAPESP\Imagens\2_Grafico_Fx_x.png');
...
legend('Acústica cinética', 'Gor''kov');
saveas(3,'D:\Usuarios\IC\Relatório final FAPESP\Imagens\2_Grafico_Fy_x.png');
...
ylabel('Força no eixo x [\muN]');
legend('Acústica cinética', 'Gor''kov');
saveas(2,'D:\Usuarios\IC\Relatório final FAPESP\Imagens\2_Grafico_Fx_y.png');
...
ylabel('Força no eixo y [\muN]');
legend('Acústica cinética', 'Gor''kov');
saveas(4,'D:\Usuarios\IC\Relatório final FAPESP\Imagens\2_Grafico_Fy_y.png');